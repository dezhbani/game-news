    ...
    return (
        <div className='w-full text-white font-normal dir-rtl'>
                        ...
                        <div className='flex flex-col mt-6 lg:mt-14 gap-4 text-base'>
                            <div className='flex items-center w-full '>
                                <span className='relative w-full'>
                                    ...
                                    <input className='bg-gray outline-none w-full h-[50px] pl-2 dir-ltr placeholder:float-right pr-16 rounded-2xl placeholder:text-white placeholder:font-normal' value={email} onChange={handleChange} type='email' placeholder='ایمیل خود را وارد کنید' />
                                </span>
            ...
            <div className='bg-orange h-14 px-5 md:px-24'>
                <div className='flex text-xs justify-between md:text-base items-center h-full max-w-screen-xl m-auto'>
