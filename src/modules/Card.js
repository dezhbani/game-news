...
const Card = ({data, color=null}, props) => {
    ...
    return (
        <div className="flex flex-col w-[420px] xl:w-[540px] h-72 text-white rounded-[32px] border-2 border-white border-opacity-35 bg-black bg-opacity-10 backdrop-blur-[114px] shadow-lg py-4 px-8">
